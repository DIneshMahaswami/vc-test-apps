...
SELECT '1', 'user2.jpeg', 'image/png', '16541', 'users', NULL, 'r2', 'VC_BUCKET', NULL, NULL, 'prod/hd-demo-1/2/users/1780487392933_user2_jpeg', '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "files" ("id", "name", "content_type", "size", "resource", "resource_id", "engine", "bucket", "prefix", "region", "storage_system_key", "tenant_id")
SELECT '2', 'profile_image.jpg', 'image/png', '181436', 'users', NULL, 'r2', 'VC_BUCKET', NULL, NULL, 'prod/hd-demo-1/2/users/1780487692213_profile_image_jpg', '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
WHERE EXISTS (SELECT 1 FROM "files" ref WHERE ref."id" = '1') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "users" ("id", "first_name", "last_name", "email", "mobile_no", "role", "is_active", "creation_date", "scope_extensions", "image_file_id", "image_file_name", "tenant_id")
SELECT '2', 'Dinesh Sharma', 'Customer', 'dinesh+cust@mahaswami.com', '1234567890', 'customer', TRUE, NULL, '{"customers":[3]}', '2', 'profile_image.jpg', '2'
WHERE EXISTS (SELECT 1 FROM "files" ref WHERE ref."id" = '2') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', 'InfoTech Solutions Pvt Ltd', 'it_services', 'AADCI1234F', '29AADCI1234F1Z5', 'Rajesh Kumar', '+91-9876543210', 'dinesh+infotech@mahaswami.com', 'Priya Sharma', '+91-9876543211', 'priya@infotechsolutions.in', 'Brigade Gateway', '7B', '26/1 Dr Rajkumar Road', 'Malleshwaram', 'Bangalore', 'Karnataka', '560055', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '2', 'MediCare Pharmacy Ltd', 'healthcare', 'AABCM5678G', '29AABCM5678G1Z3', 'Dr. Amit Patel', '+91-9123456780', 'dinesh+medicare@mahaswami.com', 'Sneha Reddy', '+91-9123456781', 'sneha@medicarepharm.com', 'Sigma Tech Park', '304', 'Outer Ring Road', 'Marathahalli', 'Bangalore', 'Karnataka', '560037', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '3', 'Sharma Enterprises', 'retail', 'AAFHS9012H', '27AAFHS9012H1Z8', 'Vikram Sharma', '+91-9988776655', 'dinesh+sharma@mahaswami.com', 'Anjali Sharma', '+91-9988776656', 'anjali@sharmaenterprises.co.in', 'Trade Center', '12A', 'FC Road', 'Shivajinagar', 'Pune', 'Maharashtra', '411005', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '4', 'Design Studio Co', 'consulting', 'AACDS3456J', '27AACDS3456J1Z1', 'Neha Mehta', '+91-9765432100', 'dinesh+designstudio@mahaswami.com', 'Karan Singh', '+91-9765432101', 'karan@designstudio.co', 'Ashoka Chambers', '501', 'Bund Garden Road', 'Pune Cantonment', 'Pune', 'Maharashtra', '411001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '5', 'Fresh Foods Mumbai', 'retail', 'AAFFF7890K', '27AAFFF7890K1Z6', 'Sanjay Gupta', '+91-9876541230', 'dinesh+freshfoods@mahaswami.com', 'Meera Joshi', '+91-9876541231', 'meera@freshfoods.in', 'Peninsula Towers', '15C', 'Lower Parel', 'Elphinstone Road', 'Mumbai', 'Maharashtra', '400013', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', '1', '$2a$10$qhTQPl1dXKYqv8H1Wutvo.Z0DpUxChUdmYVWek5asJ5k7tgDhQcAC', '2026-06-03T11:05:41.244Z', '$2a$10$qhTQPl1dXKYqv8H1Wutvo.Z0DpUxChUdmYVWek5asJ5k7tgDhQcAC', NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "password_auths" ("id", "user_id", "password_hash", "last_password_change_date", "recent_password_hashes", "password_reset_token", "password_reset_expires_date", "locked_until", "lockout_count", "force_password_change_flag", "tenant_id")
SELECT '2', '2', '$2a$10$5Tl4hWBRFOtyieXNqXIhuOPaxTcMBbWVcc/gyiVY8xjwr7ctCW90S', '2026-06-03T11:53:23.253Z', NULL, NULL, NULL, NULL, NULL, FALSE, '2'
...
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "session_records" ("id", "user_id", "app_version", "sign_in_at", "ip_address", "location", "device_info", "auth_method", "session_token_hash", "session_token_expires_at", "is_active", "sign_out_at", "sign_out_reason", "tenant_id")
SELECT '3', '2', 'dev', '2026-06-03T11:53:25.040Z', '2409:4091:9031:fe09:4af0:5a9d:3f73:cd85', '{"city":"Chennai","country":"IN","country_code":"IN"}', 'Linux - Chrome (Chennai, IN)', 'password', 'ad7d6673be0b2bdb37875febbf763e848ea625f716fcf2910425d231a3db1ecc', '2026-06-05T11:53:25.040Z', FALSE, '2026-06-03T11:59:02.986Z', 'manual', '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '2') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "session_records" ("id", "user_id", "app_version", "sign_in_at", "ip_address", "location", "device_info", "auth_method", "session_token_hash", "session_token_expires_at", "is_active", "sign_out_at", "sign_out_reason", "tenant_id")
...
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
  ...
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "user_security_profiles" ("id", "user_id", "email", "last_login_date", "failed_login_attempts_count", "creation_ip_address", "creation_location", "auth_policy_id", "is_password_enrolled", "is_authenticator_enrolled", "is_passkey_enrolled", "primary_method", "recovery_codes_remaining_count", "totp_credential_id", "password_auth_id", "passkey_credential_identifiers", "is_new_location_notify_enabled", "is_new_device_notify_enabled", "is_account_lockout_notify_enabled", "bypass_code_hash", "bypass_code_expires_at", "setup_token", "setup_token_expires_at", "inactive_locked_at", "tenant_id")
SELECT '2', '2', 'dinesh+cust@mahaswami.com', '2026-06-03T12:01:26.363Z', '0', NULL, NULL, '1', TRUE, FALSE, FALSE, 'password', '0', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '2') AND
  EXISTS (SELECT 1 FROM "auth_policies" ref WHERE ref."id" = '1') AND
  EXISTS (SELECT 1 FROM "password_auths" ref WHERE ref."id" = '2') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
