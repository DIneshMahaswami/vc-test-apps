import { Resource, createDefaults, tableDefaults,
	...
	type ResourceActionDefs, type FieldSchema, MoneyField, MoneyInput, RichTextField, RichTextInput, CardGrid, BooleanLiveFilter, ReferenceLiveFilter, ChoicesLiveFilter, MoneyLiveFilter, NumberLiveFilter, TextLiveFilter} from '@mahaswami/vc-frontend';
import { Apartment } from '@mui/icons-material';
import { Create, Edit, List, Menu, Show,
    type ListProps, TextField, TextInput, BooleanField, BooleanInput, NumberField, NumberInput, SelectField, SelectInput, AutocompleteInput, RadioButtonGroupInput, required, useUnique} from "react-admin";
...
export const statusChoices = [{ id: 'available', name: 'Available' }, { id: 'reserved', name: 'Reserved' }, { id: 'occupied', name: 'Occupied' }, { id: 'under_maintenance', name: 'Under Maintenance' }];
export const StatusChoiceField = (props: any) => <SelectField {...props} choices={statusChoices} />;

export const RentPerSqftPriceMoneyField = (props: any) => <MoneyField {...props} currency="USD" />;
export const MaintenancePerSqftPriceMoneyField = (props: any) => <MoneyField {...props} currency="USD" />;
...
const detail0Filters = [
    ...
    <MoneyLiveFilter source="rent_per_sqft_price" label="Rent Per Sqft" currency="USD" />,
    <MoneyLiveFilter source="maintenance_per_sqft_price" label="Maintenance Per Sqft" currency="USD" />,
...
const UnitForm = (props: any) => {
    ...
    return (
        <SimpleForm {...formDefaults(props)} display="grid"  gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }}  gap="1rem" >
            ...
            <MoneyInput source="rent_per_sqft_price" currency="USD" />
            <MoneyInput source="maintenance_per_sqft_price" currency="USD" />
    ...
    return (
        <List {...listDefaults(props)}>
            <DataTable {...tableDefaults(props)} hiddenColumns={['maintenance_per_sqft_price', 'status', 'is_furnished']} >
                ...
                <DataTable.Col source="rent_per_sqft_price" field={RentPerSqftPriceMoneyField}/>
                <DataTable.Col source="maintenance_per_sqft_price" field={MaintenancePerSqftPriceMoneyField}/>
    ...
    return (
        <Show {...showDefaults(props)}>
            <SimpleShowLayout display="grid"  gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }}  gap="1rem" >
                ...
                <MoneyField source="rent_per_sqft_price" currency="USD" />
                <MoneyField source="maintenance_per_sqft_price" currency="USD" />
...
const unitsFieldSchema: FieldSchema = {
    ...
    floor: {},
    sqft_number: {},
    rent_per_sqft_price: { type: 'money', currency: 'USD' },
    maintenance_per_sqft_price: { type: 'money', currency: 'USD' },
...
export const UnitsResource = (
    <Resource
        ...
        hasColumnChooser
        hasFilterChooser
        toolbarPriority='action-compact'
    />
)
