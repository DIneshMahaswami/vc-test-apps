...
export const BaseAmountMoneyField = (props: any) => <MoneyField {...props} currency="USD" />;
export const GstAmountMoneyField = (props: any) => <MoneyField {...props} currency="USD" />;
export const TotalAmountMoneyField = (props: any) => <MoneyField {...props} currency="USD" />;
...
const filters = [
    ...
    <MoneyLiveFilter source="base_amount" label="Base" currency="USD" />,
    <MoneyLiveFilter source="gst_amount" label="Gst" currency="USD" />,
    <MoneyLiveFilter source="total_amount" label="Total" currency="USD" />
]
