...
export const PaymentAmountMoneyField = (props: any) => <MoneyField {...props} currency="USD" />;
...
const filters = [
    ...
    <MoneyLiveFilter source="payment_amount" label="Payment" currency="USD" />
]
...
const PaymentForm = (props: any) => {
    return (
        <SimpleForm {...formDefaults(props)}>
            ...
            <MoneyInput source="payment_amount" currency="USD" validate={required()} />
        </SimpleForm>
    )
}
    ...
    return (
        <Show {...showDefaults(props)}>
            <SimpleShowLayout>
                ...
                <MoneyField source="payment_amount" currency="USD" />
            </SimpleShowLayout>
        </Show>
    )
}
