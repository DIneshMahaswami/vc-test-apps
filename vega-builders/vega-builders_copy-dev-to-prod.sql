...
DELETE FROM "files";
INSERT INTO "files" ("id", "name", "content_type", "size", "resource", "resource_id", "engine", "bucket", "prefix", "region", "storage_system_key", "tenant_id")
SELECT '3', 'output-onlinepngtools (1).png', 'image/png', '281408', 'users', NULL, 'r2', 'VC_BUCKET', NULL, NULL, 'prod/hd-demo-1/2/users/1780410044781_output_onlinepngtools__1__png', '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', 'Dinesh', 'R', 'dinesh@mahaswami.com', NULL, 'admin', TRUE, '2026-06-02T12:44:55.371Z', NULL, '3', 'output-onlinepngtools (1).png', '2'
WHERE EXISTS (SELECT 1 FROM "files" ref WHERE ref."id" = '3') AND
...
SELECT '1', 'InfoTech Solutions Pvt Ltd', 'it_services', 'AADCI1234F', '29AADCI1234F1Z5', 'Rajesh Kumar', '+91-9876543210', 'dinesh+infotech@mahaswami.com', 'Priya Sharma', '+91-9876543211', 'dinesh+priya@mahaswami.com', 'Brigade Gateway', '7B', '26/1 Dr Rajkumar Road', 'Malleshwaram', 'Bangalore', 'Karnataka', '560055', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '2', 'MediCare Pharmacy Ltd', 'healthcare', 'AABCM5678G', '29AABCM5678G1Z3', 'Dr. Amit Patel', '+91-9123456780', 'dinesh+medicare@mahaswami.com', 'Sneha Reddy', '+91-9123456781', 'dinesh+sneha@mahaswami.com', 'Sigma Tech Park', '304', 'Outer Ring Road', 'Marathahalli', 'Bangalore', 'Karnataka', '560037', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '3', 'Sharma Enterprises', 'retail', 'AAFHS9012H', '27AAFHS9012H1Z8', 'Vikram Sharma', '+91-9988776655', 'dinesh+sharma@mahaswami.com', 'Anjali Sharma', '+91-9988776656', 'dinesh+anjali@mahaswami.com', 'Trade Center', '12A', 'FC Road', 'Shivajinagar', 'Pune', 'Maharashtra', '411005', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '4', 'Design Studio Co', 'consulting', 'AACDS3456J', '27AACDS3456J1Z1', 'Neha Mehta', '+91-9765432100', 'dinesh+designstudio@mahaswami.com', 'Karan Singh', '+91-9765432101', 'dinesh+karan@mahaswami.com', 'Ashoka Chambers', '501', 'Bund Garden Road', 'Pune Cantonment', 'Pune', 'Maharashtra', '411001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "customers" ("id", "business_name", "business_type", "business_pan", "gstin", "primary_contact_name", "primary_contact_phone", "primary_contact_email", "secondary_contact_name", "secondary_contact_phone", "secondary_contact_email", "registered_building_name", "registered_suite", "registered_address_line_1", "registered_address_line_2", "registered_city", "registered_state", "registered_pin_code", "incorporation_certificate_attachment_file_id", "memorandum_of_articles_attachment_file_id", "articles_of_association_attachment_file_id", "gst_registration_attachment_file_id", "incorporation_certificate_attachment_file_name", "memorandum_of_articles_attachment_file_name", "articles_of_association_attachment_file_name", "gst_registration_attachment_file_name", "tenant_id")
SELECT '5', 'Fresh Foods Mumbai', 'retail', 'AAFFF7890K', '27AAFFF7890K1Z6', 'Sanjay Gupta', '+91-9876541230', 'dinesh+freshfoods@mahaswami.com', 'Meera Joshi', '+91-9876541231', 'dinesh+meera@mahaswami.com', 'Peninsula Towers', '15C', 'Lower Parel', 'Elphinstone Road', 'Mumbai', 'Maharashtra', '400013', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', '1', '$2a$10$sDE9kPA76ZXOSOS.ztm0/OMmCmNZKPMpuZjbtg7fruiDxec55.sJ6', '2026-06-02T12:44:55.457Z', '$2a$10$sDE9kPA76ZXOSOS.ztm0/OMmCmNZKPMpuZjbtg7fruiDxec55.sJ6', NULL, NULL, NULL, NULL, NULL, '2'
...
SELECT '1', '1', 'dev', '2026-06-02T12:47:24.947Z', '2409:4091:9031:fe09:ecc5:8c6e:a1df:a644', '{"city":"Chennai","country":"IN","country_code":"IN"}', 'Linux - Chrome (Chennai, IN)', 'password', 'aeb16981ca034fd1b4663f50d5b27e680e302fba265b66ff546d86297e6d2693', '2026-06-04T12:47:24.947Z', FALSE, '2026-06-02T14:06:39.099Z', 'manual', '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
INSERT INTO "session_records" ("id", "user_id", "app_version", "sign_in_at", "ip_address", "location", "device_info", "auth_method", "session_token_hash", "session_token_expires_at", "is_active", "sign_out_at", "sign_out_reason", "tenant_id")
SELECT '2', '1', 'dev', '2026-06-02T14:07:56.420Z', '2409:4091:9031:fe09:ecc5:8c6e:a1df:a644', '{"city":"Chennai","country":"IN","country_code":"IN"}', 'Linux - Chrome (Chennai, IN)', 'password', 'f575e9edfbe989e233df2c7c5e34857c567a140eb110b16ce16c9c43c4e20636', '2026-06-04T14:07:56.420Z', TRUE, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
  EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', '1', 'dinesh@mahaswami.com', '2026-06-02T14:07:56.420Z', '0', NULL, NULL, '1', TRUE, FALSE, FALSE, 'password', '0', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
