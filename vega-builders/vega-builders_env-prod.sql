...
SELECT '1', 'Dinesh', 'R', 'dinesh@mahaswami.com', NULL, 'admin', TRUE, '2026-06-02T13:48:34.968Z', NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', '1', '$2a$10$2TK752LWS/DwlhlrrB8uG.6jP1aZ4WvTL1XCx3jYqc8ov4n7TeEKG', '2026-06-02T13:48:35.095Z', '$2a$10$2TK752LWS/DwlhlrrB8uG.6jP1aZ4WvTL1XCx3jYqc8ov4n7TeEKG', NULL, NULL, NULL, NULL, NULL, '2'
...
SELECT '1', '1', 'dinesh@mahaswami.com', NULL, '0', NULL, NULL, '1', TRUE, FALSE, FALSE, 'password', '0', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
