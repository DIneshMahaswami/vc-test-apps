...
SELECT '1', 'Dinesh', 'Admin', 'dinesh@mahaswami.com', NULL, 'admin', TRUE, '2026-07-16T07:13:48.463Z', NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "tenants" ref WHERE ref."id" = '2');
...
SELECT '1', '1', '$2a$10$maoX3l5qya7IzK.oF10pPecR25FSYmbWgUHRUW1FVvnqtqFjdN1tq', '2026-07-16T07:13:48.558Z', '$2a$10$maoX3l5qya7IzK.oF10pPecR25FSYmbWgUHRUW1FVvnqtqFjdN1tq', NULL, NULL, NULL, NULL, NULL, '2'
...
SELECT '1', '1', 'dinesh@mahaswami.com', NULL, NULL, '0', NULL, NULL, '1', TRUE, FALSE, FALSE, 'password', '0', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2'
WHERE EXISTS (SELECT 1 FROM "users" ref WHERE ref."id" = '1') AND
