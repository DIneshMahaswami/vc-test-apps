...
export const WorkOrderAmountMoneyField = (props: any) => <MoneyField {...props} currency="INR" />;
...
const filters = [
    ...
    <MoneyLiveFilter source="work_order_amount" label="Work Order" currency="INR" />
]
...
const WorkOrderForm = (props: any) => {
    return (
        <SimpleForm {...formDefaults(props)} display="grid"  gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }}  gap="1rem" >
            ...
            <MoneyInput source="work_order_amount" currency="INR" />
    ...
    return (
        <Show {...showDefaults(props)}>
            <SimpleShowLayout display="grid"  gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }}  gap="1rem" >
                ...
                <MoneyField source="work_order_amount" currency="INR" />
...
const workOrdersFieldSchema: FieldSchema = {
    ...
    work_order_amount: { type: 'money', currency: 'INR' },
    notes: { ui: 'multiline' }
};
